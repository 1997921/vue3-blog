...
<script lang="ts">
import { type DraggableStart, type DraggableHandle, type DraggableEnd, type Removes, type HandleType } from '../types'
...
import { defineComponent, onMounted, ref, watchEffect, provide, watch } from 'vue';
